...
struct ListResponse: Decodable {
    /// optional array of meals (desserts).
    var meals: [Meal]?
}
...
struct Meal: Decodable, Identifiable {
    ...
    /// name of the meall
    let strMeal: String
    /// URL string for the image of the meal.
    let strMealThumb: String
    /// Computed property for the identifier, conforms to the Identifiable protocol
...
/// Represents detailed information of a recipe
struct RecipeDetail: Codable {
    ...
    /// array of measurements (in corresponding order to the ingredients used in the recipe above)
